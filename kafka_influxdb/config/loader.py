...
def parse_args():
    ...
    parser.add_argument('--kafka_host', type=str, default=argparse.SUPPRESS, required=False, help="Hostname or IP of Kafka message broker (default: localhost)")
    parser.add_argument('--kafka_port', type=int, default=argparse.SUPPRESS, required=False, help="Port of Kafka message broker (default: 9092)")
    parser.add_argument('--kafka_topic', type=str, default=argparse.SUPPRESS, required=False, help="Topic for metrics (default: my_topic)")
    parser.add_argument('--kafka_group', type=str, default=argparse.SUPPRESS, required=False, help="Kafka consumer group (default: my_group)")
    parser.add_argument('--influxdb_host', type=str, default=argparse.SUPPRESS, required=False, help="InfluxDB hostname or IP (default: localhost)")
    ...
    parser.add_argument('--influxdb_use_ssl', default=argparse.SUPPRESS, help="Use SSL connection for InfluxDB (default: False)")
    parser.add_argument('--influxdb_verify_ssl', default=argparse.SUPPRESS, help="Verify the SSL certificate before connecting (default: False)")
    parser.add_argument('--influxdb_timeout', type=int, default=argparse.SUPPRESS, help="Max number of seconds to establish a connection to InfluxDB (default: 5)")
    parser.add_argument('--influxdb_use_udp', default=argparse.SUPPRESS, help="Use UDP connection for InfluxDB (default: False)")
    ...
    parser.add_argument('--buffer_size', type=int, default=argparse.SUPPRESS, help="Maximum number of messages that will be collected before flushing to the backend (default: 1000)")
    parser.add_argument('-c', '--configfile', type=str, default=argparse.SUPPRESS, help="Configfile path (default: None)")
    parser.add_argument('-s', '--statistics', default=argparse.SUPPRESS, action="store_true", help="Show performance statistics (default: True)")
    parser.add_argument('-b', '--benchmark', default=argparse.SUPPRESS, action="store_true", help="Run benchmark (default: False)")
    parser.add_argument('-v', '--verbose', action='count', default=argparse.SUPPRESS, help="Set verbosity level. Increase verbosity by adding a v: -v -vv -vvv (default: 0)")
